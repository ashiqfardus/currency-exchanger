                        ...
                        <form method="POST" action="{{ route('currency.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-6 col-sm-12">
                                    ...
                                    <input type="number" class="form-control @error('reserve') is-invalid @enderror" id="reserve" placeholder="Reserve amount" name="reserve" value="{{old('reserve')}}" data-parsley-required="true" data-parsley-min="0" step="0.1" data-parsley-type="number">
                                    @error('reserve')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
