                ...
                <div class="col-12 col-xxl-6">
                    ...
                    <div class="row align-items-center g-4">
                        <div class="col-12 col-md-auto">
                            <div class="d-flex align-items-center"><img src="{{asset('assets/img/icons/illustrations/4l.png')}}" alt="" height="46" width="46" />
                                <div class="ms-3">
                        ...
                        <div class="col-12 col-md-auto">
                            <div class="d-flex align-items-center"><img src="{{asset('assets/img/icons/illustrations/3l.png')}}" alt="" height="46" width="46" />
                                <div class="ms-3">
                        ...
                        <div class="col-12 col-md-auto">
                            <div class="d-flex align-items-center"><img src="{{asset('assets/img/icons/illustrations/2l.png')}}" alt="" height="46" width="46" />
                                <div class="ms-3">
                    ...
                    <table class="table fs--1 mb-0 border-top border-200">
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0">
                                <div class="rounded-2 border"><img src="{{asset('assets/img/products/1.png')}}" alt="" width="53" /></div>
                            </td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0">
                                <div class="rounded-2 border"><img src="{{asset('assets/img/products/2.png')}}" alt="" width="53" /></div>
                            </td>
                            ...
                            <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center" href="#!">
                                    <div class="avatar avatar-l"><img class="rounded-circle" src="{{asset('assets/img/team/59.png')}}" alt="" /></div>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0">
                                <div class="rounded-2 border"><img src="{{asset('assets/img/products/3.png')}}" alt="" width="53" /></div>
                            </td>
                            ...
                            <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center" href="#!">
                                    <div class="avatar avatar-l"><img class="rounded-circle" src="{{asset('assets/img/team/58.png')}}" alt="" /></div>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0">
                                <div class="rounded-2 border"><img src="{{asset('assets/img/products/4.png')}}" alt="" width="53" /></div>
                            </td>
                            ...
                            <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center" href="#!">
                                    <div class="avatar avatar-l"><img class="rounded-circle avatar-placeholder" src="{{asset('assets/img/team/avatar.png')}}" alt="" /></div>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0">
                                <div class="rounded-2 border"><img src="{{asset('assets/img/products/5.png')}}" alt="" width="53" /></div>
                            </td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0">
                                <div class="rounded-2 border"><img src="{{asset('assets/img/products/6.png')}}" alt="" width="53" /></div>
                            </td>
                            ...
                            <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center" href="#!">
                                    <div class="avatar avatar-l"><img class="rounded-circle" src="{{asset('assets/img/team/57.png')}}" alt="" /></div>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0">
                                <div class="rounded-2 border"><img src="{{asset('assets/img/products/7.png')}}" alt="" width="53" /></div>
                            </td>
                            ...
                            <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center" href="#!">
                                    <div class="avatar avatar-l"><img class="rounded-circle" src="{{asset('assets/img/team/3.png')}}" alt="" /></div>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0">
                                <div class="rounded-2 border"><img src="{{asset('assets/img/products/8.png')}}" alt="" width="53" /></div>
                            </td>
                            ...
                            <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center" href="#!">
                                    <div class="avatar avatar-l"><img class="rounded-circle" src="{{asset('assets/img/team/26.png')}}" alt="" /></div>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0">
                                <div class="rounded-2 border"><img src="{{asset('assets/img/products/9.png')}}" alt="" width="53" /></div>
                            </td>
                            ...
                            <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center" href="#!">
                                    <div class="avatar avatar-l"><img class="rounded-circle" src="{{asset('assets/img/team/29.png')}}" alt="" /></div>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0">
                                <div class="rounded-2 border"><img src="{{asset('assets/img/products/10.png')}}" alt="" width="53" /></div>
                            </td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0">
                                <div class="rounded-2 border"><img src="{{asset('assets/img/products/11.png')}}" alt="" width="53" /></div>
                            </td>
                            ...
                            <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center" href="#!">
                                    <div class="avatar avatar-l"><img class="rounded-circle" src="{{asset('assets/img/team/8.png')}}" alt="" /></div>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0">
                                <div class="rounded-2 border"><img src="{{asset('assets/img/products/12.png')}}" alt="" width="53" /></div>
                            </td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0">
                                <div class="rounded-2 border"><img src="{{asset('assets/img/products/13.png')}}" alt="" width="53" /></div>
                            </td>
                            ...
                            <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center" href="#!">
                                    <div class="avatar avatar-l"><img class="rounded-circle" src="{{asset('assets/img/team/9.png')}}" alt="" /></div>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0">
                                <div class="rounded-2 border"><img src="{{asset('assets/img/products/14.png')}}" alt="" width="53" /></div>
                            </td>
                        ...
                        <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                            ...
                            <td class="align-middle product white-space-nowrap py-0">
                                <div class="rounded-2 border"><img src="{{asset('assets/img/products/15.png')}}" alt="" width="53" /></div>
                            </td>
                            ...
                            <td class="align-middle customer white-space-nowrap"><a class="d-flex align-items-center" href="#!">
                                    <div class="avatar avatar-l"><img class="rounded-circle" src="{{asset('assets/img/team/24.png')}}" alt="" /></div>
