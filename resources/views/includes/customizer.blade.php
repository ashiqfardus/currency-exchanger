    ...
    <div class="offcanvas-body scrollbar px-card" id="themeController">
        <div class="border rounded-3 p-4">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="form-check form-switch mb-0"><input class="form-check-input" type="checkbox" data-theme-control="isRTL" /></div>
            </div>
            ...
            <div class="row gx-2">
                <div class="col-6">
                    ...
                    <label class="btn d-inline-block btn-navbar-style fs--1" for="themeSwitcherLight">
                        <span class="mb-2 rounded d-block">
                            <img class="img-fluid img-prototype mb-0" src="{{asset('assets/img/generic/default-light.png')}}" alt=""/>
                        </span>
                ...
                <div class="col-6">
                    ...
                    <label class="btn d-inline-block btn-navbar-style fs--1" for="themeSwitcherDark">
                        <span class="mb-2 rounded d-block">
                            <img class="img-fluid img-prototype mb-0" src="{{asset('assets/img/generic/default-dark.png')}}" alt=""/>
                        </span>
                ...
                <div class="col-6">
                    ...
                    <label class="btn d-inline-block btn-navbar-style fs--1" for="navbarPositionVertical">
                        <span class="mb-2 rounded d-block">
                            ...
                            <img class="img-fluid img-prototype d-light-none" src="{{asset('assets/img/generic/default-dark.png')}}" alt=""/>
                        </span>
                ...
                <div class="col-6">
                    ...
                    <label class="btn d-inline-block btn-navbar-style fs--1" for="navbarPositionHorizontal">
                        <span class="mb-2 rounded d-block">
                            ...
                            <img class="img-fluid img-prototype d-light-none" src="{{asset('assets/img/generic/top-default-dark.png')}}" alt=""/>
                        </span>
                ...
                <div class="col-6">
                    ...
                    <label class="btn d-inline-block btn-navbar-style fs--1" for="navbarPositionCombo">
                        <span class="mb-2 rounded d-block">
                            ...
                            <img class="img-fluid img-prototype d-light-none" src="{{asset('assets/img/generic/nav-combo-dark.png')}}" alt=""/>
                        </span>
            ...
            <div class="row gx-2">
                ...
                <div class="col-6">
                    ...
                    <label class="btn d-block w-100 btn-navbar-style fs--1" for="navbar-style-dark">
                        <img class="img-fluid img-prototype d-dark-none" src="{{asset('assets/img/generic/vertical-darker.png')}}" alt="" />
                        <img class="img-fluid img-prototype d-light-none" src="{{asset('assets/img/generic/vertical-lighter.png')}}" alt="" />
            ...
            <div class="row gx-2">
                ...
                <div class="col-6">
                    ...
                    <label class="btn d-inline-block btn-navbar-style fs--1" for="navbarShapeSlim">
                        <span class="mb-2 rounded d-block">
                            <img class="img-fluid img-prototype d-dark-none mb-0" src="{{asset('assets/img/generic/top-slim.png')}}" alt=""/>
                            <img class="img-fluid img-prototype d-light-none mb-0" src="{{asset('assets/img/generic/top-slim-dark.png')}}" alt=""/>
                        </span>
            ...
            <div class="row gx-2">
                <div class="col-6">
                    ...
                    <label class="btn d-inline-block btn-navbar-style fs--1" for="navbarTopDefault">
                        <span class="mb-2 rounded d-block">
                            <img class="img-fluid img-prototype d-dark-none mb-0" src="{{asset('assets/img/generic/top-default.png')}}" alt=""/>
                            <img class="img-fluid img-prototype d-light-none mb-0" src="{{asset('assets/img/generic/top-style-darker.png')}}" alt=""/>
                        </span>
                        <span class="label-text">Default</span>
                    </label>
                </div>
                <div class="col-6">
                    ...
                    <label class="btn d-inline-block btn-navbar-style fs--1" for="navbarTopDarker">
                        <span class="mb-2 rounded d-block">
                            ...
                            <img class="img-fluid img-prototype d-light-none mb-0" src="{{asset('assets/img/generic/top-style-lighter.png')}}" alt=""/>
                        </span>
                        <span class="label-text d-dark-none">Darker</span>
                        <span class="label-text d-light-none">Lighter</span>
                    </label>
