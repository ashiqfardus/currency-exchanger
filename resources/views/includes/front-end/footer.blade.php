<footer class="footer-wrap">
    <div class="container">
            ...
            <div class="col-xl-3 col-lg-5 col-md-5 col-sm-6">
                <div class="footer-widget">
                    <a href="index.html" class="footer-logo">
                        <img src="{{asset('/')}}front-end/img/logo-white.png" alt="Image">
                    </a>
                    <p class="comp-desc">
                        Lorem ipsum dolor sit amet consc tetur adicing elit. Dolor emque dicta molest enim beatae
                        ame consequ atur tempo pretium auctor nam.
                    </p>
                ...
                <div class="footer-widget">
                    ...
                    <ul class="contact-info list-style">
                        ...
                        <li>
                            ...
                            <h6>Email</h6>
                            <a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#f098959c9c9fb093859588de939f9d"><span
                                    class="__cf_email__" data-cfemail="224a474e4e4d624157475a0c414d4f">[email&#160;protected]</span></a>
                        </li>
                        <li>
        ...
        <div class="row">
            <div class="col-md-12">
                <p class="copyright-text">@php date('Y') @endphp<i class="ri-copyright-line"></i> <span>{{ config('app.name', 'Laravel') }}</span>. All Rights Reserved</p>
            </div>
        </div>
    </div>
</footer>
